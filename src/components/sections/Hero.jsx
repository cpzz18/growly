  ...
  return (
    <section className="relative px-4 pt-32 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto text-center max-w-7xl">
        {/* Status Badge */}
        <div className="inline-flex items-center px-4 py-2 mb-6 space-x-2 border rounded-full bg-slate-900/50 backdrop-blur-sm border-slate-800/50">
        ...
        <div className="flex flex-col justify-center gap-4 mb-20 sm:flex-row">
          <a
            href="#contact"
            className="flex items-center justify-center px-8 py-4 space-x-2 text-sm font-bold transition bg-green-500 rounded-lg shadow-xl group hover:bg-green-600 text-slate-950 shadow-green-500/20 hover:shadow-green-500/40"
          >
          ...
          <a
            href="#packages"
            className="px-8 py-4 text-sm font-bold text-white transition border-2 rounded-lg border-slate-800 hover:border-cyan-500/50 bg-slate-900/50 backdrop-blur-sm"
          >
            {t.hero.cta2}
          </a>
        </div>
